...
CREATE TYPE "public"."message_scope" AS ENUM('all', 'team');
--> statement-breakpoint
CREATE TYPE "public"."team" AS ENUM('cops', 'thieves');
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "chat_messages" ADD CONSTRAINT "chat_messages_room_code_game_sessions_room_code_fk" FOREIGN KEY ("room_code") REFERENCES "public"."game_sessions"("room_code") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "moves_history" ADD CONSTRAINT "moves_history_room_code_game_sessions_room_code_fk" FOREIGN KEY ("room_code") REFERENCES "public"."game_sessions"("room_code") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "game_sessions_status_idx" ON "game_sessions" USING btree ("game_status");
--> statement-breakpoint
CREATE INDEX "moves_room_turn_idx" ON "moves_history" USING btree ("room_code", "turn_number");
--> statement-breakpoint
CREATE INDEX "players_room_team_idx" ON "players" USING btree ("room_code", "team");
--> statement-breakpoint
